...
use crate::frontend::expression::{
    Branch, Cast, Chain, Composed, Expression, Function, Inspect, Loop, LoopOr, Map, Replace,
    Something, Times, TimesOr, Transformation, Type, TypedIdentifier,
};
...
fn track_identifiers_recursive(
    ...
    match expression {
        ...
        Expression::Composed(Composed::Cast(_)) => Ok(()),
    }
}
